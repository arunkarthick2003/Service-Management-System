...
<div>
    <center>
        <div style="margin-top:70px; color:#4B0082; font-size:16px;"><h1>TV Repair Service</h1></div>
        <form action="ServiceRegistration" id="register" method="post">
        <input type = "hidden" name = "type" value = "TV Repair">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="vender" id="vender" onchange="updateAmount()">
                        ...
                        <option value="K. Naresh" data-amount="1590/-">K. Naresh</option>
                        <option value="M. Balu" data-amount="1650/-">M. Balu</option>
                        <option value="P. Sudheer" data-amount="1600/-">P. Sudheer</option>
                    </select></td>
                </tr>
                <tr>
