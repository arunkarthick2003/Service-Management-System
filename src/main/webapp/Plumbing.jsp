...
<%@include file="cookievalidation.jsp" %>
    <div>
    <center>
        <div style="margin-top:70px; color:#4B0082; font-size:16px;"><h1>Plumbing Service</h1></div>
        <form action="ServiceRegistration" method = "post" id="register">
        <input type = "hidden" name = "type" value = "Plumbing">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="vender" id="vender" onchange="updateAmount()">
                        ...
                        <option value="M. Balu" data-amount="950/-">M. Balu</option>
                        <option value="P. Sudheer" data-amount="990/-">P. Sudheer</option>
                    </select></td>
                </tr>
                <tr>
