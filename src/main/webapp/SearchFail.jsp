        ...
        <ul class="nav-links">
            <div class="search-container">
                <form action="AdminMainSearch" id="register" method="post">
                	<input type="phone" id="search" name = "id" minlength="7" maxlength="7" pattern="[0-9]{7}" placeholder="Search by ID" onkeypress="return blockSpecialCharacters(event);" required>
