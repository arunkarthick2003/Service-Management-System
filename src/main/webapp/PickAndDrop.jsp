...
<title>P&D Repair Service Booking</title>
...
<div class="bdy">
    <div>
    <center>
        <div style="margin-top:70px; color:#4B0082; font-size:16px;"><h1>Pick And Drop Service</h1></div>
        <form action="ServiceRegistration" method = "post" id="register">
        <input type = "hidden" name = "type" value = "Pick & Drop ">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="vender" id="vender" onchange="updateAmount()">
                        ...
                        <option value="K. Naresh" data-amount="1000/-">K. Naresh</option>
                        <option value="M. Balu" data-amount="1050/-">M. Balu</option>
                        <option value="P. Sudheer" data-amount="1090/-">P. Sudheer</option>
                    </select></td>
                </tr>
                <tr>
